...
class Login_Model extends CI_Model 
{
	...
	public function getUser($email, $pass) 
	{
		...
		->where("email", $email)->where("password", $pass)->get("usuarios");
	}

	public function getUserByEmail($email) 
	{
		return $this->db->select("id_usuario,email,password,token,active")
		->where("email", $email)->get("usuarios");
	}

	public function getUserByUsername($username) 
	{
		return $this->db->select("id_usuario,email,password,token,active")
		->where("username", $username)->get("usuarios");
	}

	public function updateUserToken($userid, $token) 
	{
		$this->db->where("id_usuario", $userid)
		->update("usuarios", array("token" => $token));
	}
	...
	public function getUserEmail($email) 
	{
		...
		->select("id_usuario, username")->get("usuarios");
	}
	...
	{
		$this->db->where("id_usuario", $userid)
		->update("usuarios", array("password" => $password));
	}
