...
<hr>
	...
	<div class="panel panel-default">
  	...
  	<?php echo form_open(site_url("account/change_language_pro"), array("class" => "form-horizontal")) ?>
			<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_148") ?></label>
			    <div class="col-sm-10">
			      <select name="language" class="form-control">
			      <?php foreach($languages as $k=>$v) : ?>
			      	<option value="<?php echo $v ?>" <?php if($v == $user_lang) echo "selected" ?>><?php echo $k ?></option>
			      <?php endforeach; ?>
			      </select>
			    </div>
			</div>
