...
<td>
  <?php if($r->admin) : ?><span class="user_role_button admin"><?php echo lang("ctn_308") ?></span><?php endif; ?>
  <?php if($r->admin_settings) : ?><span class="user_role_button admin"><?php echo lang("ctn_309") ?></span><?php endif; ?>
  <?php if($r->admin_members) : ?><span class="user_role_button admin"><?php echo lang("ctn_310") ?></span><?php endif; ?>
  <?php if($r->admin_payment) : ?><span class="label label-default"><?php echo lang("ctn_311") ?></span><?php endif; ?>
</td>
<td><a href="<?php echo site_url("admin/edit_user_role/" . $r->ID) ?>" class="btn btn-warning btn-xs"><?php echo lang("ctn_55") ?></a> <a href="<?php echo site_url("admin/delete_user_role/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" onclick="return confirm('<?php echo lang("ctn_317") ?>')"><?php echo lang("ctn_57") ?></a></td></tr>
<?php endforeach; ?>
</table>
